 ...
 * квалификации. Сценарии независимых групп нарушений складываются диапазонами, а альтернативные
 * сценарии внутри одной группы (субъект, первое/повторное нарушение) не суммируются между собой.
 */
