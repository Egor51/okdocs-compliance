...
public final class NoCookieConsentRule implements Rule {
    ...
    private static final RuleDefinition DEFINITION = new RuleDefinition(
            ...
            "Необязательная обработка без раскрытого механизма не обнаружена",
            "На обследованных страницах не найдено сочетание известного трекера и отсутствующего механизма выбора.");
