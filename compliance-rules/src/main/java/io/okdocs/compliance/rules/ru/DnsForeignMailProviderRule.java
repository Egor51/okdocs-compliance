...
public final class DnsForeignMailProviderRule implements Rule {
    ...
    private static final RuleDefinition DEFINITION = new RuleDefinition(
            ...
            "В полученных MX-данных зарубежные почтовые серверы не обнаружены",
            "Если MX-записи были получены, их GeoIP-страны не содержат не-RU. Отсутствие MX не подтверждает наличие "
                    + "российского почтового провайдера.");
