...
/**
 * Чувствительная user-specific страница (ЛК/профиль/заказ/оплата) отдаётся без запрета кэширования: ответ с
...
public final class SensitivePageCacheableRule implements Rule {
    ...
    private static final RuleDefinition DEFINITION = new RuleDefinition(
            ...
            "Ответы личного кабинета, профиля, заказа или оплаты могут содержать персональные данные. Без "
            ...
            "На проверенных user-specific страницах ЛК/профиля/оплаты установлен запрет кэширования (Cache-Control: "
