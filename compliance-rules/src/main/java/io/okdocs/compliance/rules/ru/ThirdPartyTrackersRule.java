...
public final class ThirdPartyTrackersRule implements Rule {
    ...
    private static final RuleDefinition DEFINITION = new RuleDefinition(
            ...
            "Нераскрытое совпадение с каталогом трекеров не обнаружено",
            "На обследованных страницах не найдено домена из каталога трекеров, который одновременно не "
                    + "упомянут в доступном тексте политики. Неизвестные сервисы и серверные интеграции не проверяются.");
