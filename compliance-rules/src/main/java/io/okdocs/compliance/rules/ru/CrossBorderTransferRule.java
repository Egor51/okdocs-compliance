...
public final class CrossBorderTransferRule implements Rule {
    ...
    private static final RuleDefinition DEFINITION = new RuleDefinition(
            ...
            "Риск трансграничной передачи через внешние сервисы не обнаружен",
            "Сканер не выявил загрузку иностранных сервисов, которые могут указывать на трансграничную передачу ПДн.");
