...
public final class NotInRknRegistryRule implements Rule {
    ...
    private static final RuleDefinition DEFINITION = new RuleDefinition(
            ...
            "Оператор найден в реестре Роскомнадзора",
            "Автоматическая проверка нашла запись оператора в реестре Роскомнадзора. Это не отменяет "
                    + "необходимости ручной сверки оснований обработки и применимых исключений.");
